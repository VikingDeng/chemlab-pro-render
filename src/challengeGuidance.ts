...
const PREP_CHALLENGES: Record<PrepChallengeId, PrepChallengeCopy> = {
  c1: {
    ...
    productLabel: '蓝绿色沉淀',
    startHint: '先加硫酸铜，再加氢氧化钠。',
    steps: [
      { label: '硫酸铜', formulas: ['CuSO4', 'Cu(OH)2', 'Cu(NH3)4SO4'], pending: '先加入硫酸铜。', done: '铜盐已加入。' },
  ...
  c2: {
    goal: '制备白色 AgCl 沉淀',
    primaryReagents: ['硝酸银', '盐酸'],
    secondaryReagents: ['氨水', '硝酸'],
    suggestedPrompts: ['下一步', '为什么变白', '还能试什么'],
    containerFormulas: ['AgNO3', 'HCl', 'AgCl', 'HNO3'],
    productLabel: '白色沉淀',
    startHint: '先加硝酸银，再加盐酸。',
    steps: [
      { label: '硝酸银', formulas: ['AgNO3', 'AgCl'], pending: '先加入硝酸银。', done: '银盐已加入。' },
  ...
  c3: {
    ...
    productLabel: '血红色',
    startHint: '先加氯化铁，再加硫氰化钾。',
    steps: [
      { label: '氯化铁', formulas: ['FeCl3', 'Fe(SCN)3', 'Fe(OH)3'], pending: '先加入氯化铁。', done: '铁盐已加入。' },
  ...
  c4: {
    goal: '制备二氧化碳气泡',
    primaryReagents: ['碳酸钠', '盐酸'],
    secondaryReagents: ['甲基橙指示剂', '氢氧化钠'],
    suggestedPrompts: ['下一步', '为什么冒泡', '还能试什么'],
    containerFormulas: ['Na2CO3', 'HCl', 'CO2', 'NaCl'],
    productLabel: '气泡',
    startHint: '先加碳酸钠，再加盐酸。',
    steps: [
      { label: '碳酸钠', formulas: ['Na2CO3', 'CO2'], pending: '先加入碳酸钠。', done: '碳酸盐已加入。' },
  ...
  c5: {
    ...
    containerFormulas: ['I2', 'I2_org', 'CCl4', 'Hexane'],
    productLabel: '紫色层',
    startHint: '先加碘水，再加四氯化碳。',
    steps: [
      { label: '碘水', formulas: ['I2', 'I2_org'], pending: '先加入碘水。', done: '碘已加入。' },
      { label: '有机相', formulas: ['CCl4', 'Hexane', 'I2_org'], pending: '再加入四氯化碳。', done: '有机层已形成。' },
      { label: '紫色层', formulas: ['I2_org'], pending: '静置，观察哪一层变紫。', done: '紫色有机层已出现。' },
    ],
  },
  c6: {
    goal: '制备高锰酸钾褪色体系',
    primaryReagents: ['高锰酸钾', '草酸 (H₂C₂O₄)', '硫酸'],
    secondaryReagents: ['双氧水', '盐酸'],
    suggestedPrompts: ['下一步', '为什么褪色', '还能试什么'],
    containerFormulas: ['KMnO4', 'H2C2O4', 'H2SO4', 'MnSO4', 'CO2'],
    productLabel: '褪色与气泡',
    startHint: '先加高锰酸钾，再加草酸和硫酸。',
    steps: [
      { label: '高锰酸钾', formulas: ['KMnO4', 'MnSO4'], pending: '先加入高锰酸钾。', done: '紫色氧化剂已加入。' },
